...
import { Plus, Trash2, Package, Zap, Radio, Flame, Lightbulb, User } from 'lucide-react';
...
const SHELTER_EQUIPMENT_TYPES = [
  { id: 'GENSET', label: 'Genset', icon: Zap, color: 'text-yellow-500' },
  { id: 'TENDA', label: 'Tenda', icon: Package, color: 'text-blue-500' },
  { id: 'RADIO', label: 'Radio', icon: Radio, color: 'text-green-500' },
  { id: 'LAMPU', label: 'Lampu', icon: Lightbulb, color: 'text-orange-500' },
  { id: 'DAPUR_UMUM', label: 'Dapur Umum', icon: Flame, color: 'text-red-500' },
  { id: 'MEDICAL', label: 'Peralatan Medis', icon: Package, color: 'text-red-600' },
  { id: 'KOMUNIKASI', label: 'Komunikasi', icon: Radio, color: 'text-purple-500' },
  { id: 'LAINNYA', label: 'Lainnya', icon: Package, color: 'text-gray-500' },
];

export function ShelterEquipmentPanel({ shelterId: _shelterId, equipment, onAdd, onUpdate: _onUpdate, onRemove }: EquipmentPanelProps) {
  ...
  const getEquipmentIcon = (type: string) => {
    const eq = SHELTER_EQUIPMENT_TYPES.find((e) => e.id === type);
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle>Peralatan Shelter</CardTitle>
            <CardDescription>
              Kelola peralatan operasional shelter
            </CardDescription>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    {SHELTER_EQUIPMENT_TYPES.map((type) => (
...
export default ShelterEquipmentPanel;