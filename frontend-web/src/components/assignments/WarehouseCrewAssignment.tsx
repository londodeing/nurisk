...
export function WarehouseCrewAssignment({ warehouseId: _warehouseId, crew, onAssign, onRemove }: CrewAssignmentProps) {
  ...
  const [selectedRole, setSelectedRole] = useState<CrewRole>('WAREHOUSE');
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Penugasan Crew Gudang</CardTitle>
        <CardDescription>
          Kelola penugasan crew gudang berdasarkan role dan shift
        </CardDescription>
      </CardHeader>
...
export default WarehouseCrewAssignment;